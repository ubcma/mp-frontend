...
export default function CheckoutForm({ clientSecret }: { clientSecret: string }) {
  ...
  return (
    <form
      ...
      className="w-full space-y-6 rounded-2xl bg-white p-6 shadow-xl border border-gray-200"
    >
      <div className="space-y-4 bg-rose-50 border border-rose-200 rounded-xl p-5 shadow-md hover:shadow-lg transition-shadow">
        <h2 className="text-2xl font-bold text-gray-900">UBCMA Annual Membership</h2>
      ...
      <div className="space-y-4">
        <div className="flex items-center gap-2">
          ...
          <h4 className="text-sm font-medium text-gray-800">Automatic Payment Methods</h4>
        </div>
        {paymentRequest ? (
      ...
      <div className="space-y-5">
        <div className="flex items-center gap-2">
          ...
          <h4 className="text-sm font-medium text-gray-800">Card Payment</h4>
        </div>
        <PaymentElement />
      </div>
